...
class _AwalState extends State<Awal> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: new Center(
          child: new Text("Clone Traveloka"),
        ),
      ),
      body: ListView(
        children: <Widget>[
...
List<MenuTambahanItem> menuTambahan = [
  ...
  MenuTambahanItem(title: 'Internet Luar Negeri', icon: Icons.data_usage),
  MenuTambahanItem(title: 'Bioskop', icon: Icons.movie),
                    ...
                    Container(
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(
                          ...
                          bottomRight: Radius.elliptical(150, 150.0),
                        ),
                      ),
                      child: Padding(
